...
<center><h4 class="modal-title" id="myModalLabel">Add New Notice</h4></center>
...
<form method="POST" id="add_form" action="notice/insert.php" class="form-horizontal" enctype="multipart/form-data" >
...
<div class="col-lg-8">
<input type="date" class="form-control" name="start_application">
</div>
</div>
...
<div class="col-lg-8">
<input type="date" class="form-control" name="end_application">
</div>
</div>
...
<textarea class="form-control" name="form_cost"></textarea>
