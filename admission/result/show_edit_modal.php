...
<form id="edit_form<?php echo $row['id']; ?>" method="POST" action="result/update.php"  enctype="multipart/form-data">
...
<input type="date" class="form-control" name="result_publish_date" value="<?php echo $erow['result_publish_date']; ?>">
