...
<h2 class="title-1">University  Details</h2>
...
<th><center>Total Semister</center></th>

<th><center>Duration</center></th>
<th><center>University Name</center></th>
<th><center>Division</center></th>
<th><center>Academic Cost</center></th>
...
$result=$db->query("select * from uni_details");
...
<td><?php echo $row['total_semister']; ?></td>
<td><?php echo $row['duration']; ?></td>
<td><?php echo $row['university_name']; ?></td>
<td><?php echo $row['division']; ?></td>
<td><?php echo $row['academic_cost']; ?></td>
