...
$result=$mysqli->query("insert into science_faculty (id, department, seat,total_cost, duration) values ('$id','$department','$seat','$total_cost','$duration')");

if(!$result) echo "error";

$res = $mysqli->query("select id from science_faculty order by id desc");

$row = $res->fetch_row();

$_COOKIE['page']='science_faculty';
/*
$id = $row[0];
